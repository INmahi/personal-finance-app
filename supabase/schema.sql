-- XpenseTracker — full backend schema (run once on a FRESH Supabase project).
-- Dashboard → SQL Editor → paste this → Run. Equivalent to all files in
-- supabase/migrations/, consolidated (category_label already included).
